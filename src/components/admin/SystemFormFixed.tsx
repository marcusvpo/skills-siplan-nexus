...
import { useCreateSistema, useUpdateSistema } from '@/hooks/useSupabaseDataFixed';
...
interface SystemFormFixedProps {
  sistema?: Sistema | null;
  onSuccess: () => void;
  onCancel: () => void;
}

export const SystemFormFixed: React.FC<SystemFormFixedProps> = ({
  sistema,
  onSuccess,
  onCancel
}) => {
  ...
  const createSistemaMutation = useCreateSistema();
  const updateSistemaMutation = useUpdateSistema();
  ...
  const isLoading = createSistemaMutation.isPending || updateSistemaMutation.isPending;
