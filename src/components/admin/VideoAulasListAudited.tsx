...
import { VideoAulaFormAudited } from './VideoAulaFormAudited';
import { useDeleteVideoAula } from '@/hooks/useSupabaseDataAudited';
...
interface VideoAulasListAuditedProps {
  sistema: Sistema;
  produto: Produto;
...
export const VideoAulasListAudited: React.FC<VideoAulasListAuditedProps> = ({
  sistema,
  produto,
  videoAulas,
  onVideoAulasChange,
  ...
  const handleDelete = async (videoAulaId: string, videoAulaTitle: string) => {
    ...
    try {
      await deleteVideoAula.mutateAsync(videoAulaId);
      onVideoAulasChange();
    } catch (error) {
              ...
              <div className="flex flex-col space-y-2">
                ...
                <div className="flex space-x-2">
                  ...
                  <Button
                    ...
                    disabled={deleteVideoAula.isPending}
